#!/usr/bin/env python
"""
Package metadata for processline.
"""
...
setup(
    name="xblock-processline",
    version=VERSION,
    description="""Processline XBlock""",
    long_description=README + "\n\n" + CHANGELOG,
    author="OpenCraft",
    author_email="help+xblock@opencraft.com",
    url="https://github.com/open-craft/xblock-processline",
    packages=find_packages(
        include=["processline", "processline.*"],
        exclude=["*tests"],
    ),
    ...
    entry_points={
        "xblock.v1": [
            "processline = processline:ProcesslineXBlock",
        ]
    },
    package_data=package_data("processline", ["static", "public"]),
)
