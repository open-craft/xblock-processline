import type {
    ...
    ProcessLineItemModel,
    ProcessLineStylingModel,
} from './types';

export type ProcessLineItem = Required<ProcessLineItemModel>;

export type ProcessLineStyling = Required<ProcessLineStylingModel>;

export interface ProcessLineConfiguration
    extends Required<Omit<ProcessLineConfigurationModel, 'styling' | 'items'>> {
